...
class Icons {
  static hearts = {
    ...
    likedConfirmation() {
      return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="20" height="20">
        ...
        <path fill="green" d="M378.9 64c-32.4 0-62.9 15.6-81.9 41.9l28 38.7c-3 4.2-7.8 6.6-13 6.6s10-2.5 13-6.6l28-38.7c19-26.3 49.5-41.9 81.9-41.9 55.9 0 101.1 45.3 101.1 101.1 0 55-34.4 107.1-71.8 152.5-42.1 51.2-93.4 96-128.5 122.9-6.2 4.8-14.4 7.5-23.7 7.5s-17.4-2.7-23.7-7.5c-35.1-26.8-86.4-71.7-128.5-122.9-37.3-45.4-71.8-97.5-71.8-152.5z"/>
      </svg>`;
    },
    likedError() {
      return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="20" height="20">
        <path opacity=".4" fill="orange" d="M32 165.1c0-55.9 45.3-101.1 101.1-101.1 32.4 0 62.9 15.6 81.9 41.9l28 38.7c3 4.2 7.8 6.6 13 6.6s10-2.5 13-6.6l28-38.7c19-26.3 49.5-41.9 81.9-41.9 55.9 0 101.1 45.3 101.1 101.1 0 55-34.4 107.1-71.8 152.5-42.1 51.2-93.4 96-128.5 122.9-6.2 4.8-14.4 7.5-23.7 7.5s-17.4-2.7-23.7-7.5c-35.1-26.8-86.4-71.7-128.5-122.9-37.3-45.4-71.8-97.5-71.8-152.5z"/>
        <path fill="orange" d="M378.9 64c-32.4 0-62.9 15.6-81.9 41.9l28 38.7c-3 4.2-7.8 6.6-13 6.6s10-2.5 13-6.6l28-38.7c19-26.3 49.5-41.9 81.9-41.9 55.9 0 101.1 45.3 101.1 101.1 0 55-34.4 107.1-71.8 152.5-42.1 51.2-93.4 96-128.5 122.9-6.2 4.8-14.4 7.5-23.7 7.5s-17.4-2.7-23.7-7.5c-35.1-26.8-86.4-71.7-128.5-122.9-37.3-45.4-71.8-97.5-71.8-152.5z"/>
      </svg>`;
    },
    likedRemove() {
      return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="20" height="20">
        <path opacity=".4" fill="gray" d="M32 165.1c0-55.9 45.3-101.1 101.1-101.1 32.4 0 62.9 15.6 81.9 41.9l28 38.7c3 4.2 7.8 6.6 13 6.6s10-2.5 13-6.6l28-38.7c19-26.3 49.5-41.9 81.9-41.9 55.9 0 101.1 45.3 101.1 101.1 0 55-34.4 107.1-71.8 152.5-42.1 51.2-93.4 96-128.5 122.9-6.2 4.8-14.4 7.5-23.7 7.5s-17.4-2.7-23.7-7.5c-35.1-26.8-86.4-71.7-128.5-122.9-37.3-45.4-71.8-97.5-71.8-152.5z"/>
        <path fill="gray" d="M378.9 64c-32.4 0-62.9 15.6-81.9 41.9l28 38.7c-3 4.2-7.8 6.6-13 6.6s10-2.5 13-6.6l28-38.7c19-26.3 49.5-41.9 81.9-41.9 55.9 0 101.1 45.3 101.1 101.1 0 55-34.4 107.1-71.8 152.5-42.1 51.2-93.4 96-128.5 122.9-6.2 4.8-14.4 7.5-23.7 7.5s-17.4-2.7-23.7-7.5c-35.1-26.8-86.4-71.7-128.5-122.9-37.3-45.4-71.8-97.5-71.8-152.5z"/>
      </svg>`;
    },
    likedHover() {
      return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="20" height="20">
  ...
  static general = {
    ...
    playlist(size = 36) {
      return `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="color: rgba(var(--accent-coral));"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/></svg>`;
    },
    chevronDown() {
    ...
    checkBadge(size = 16) {
      return `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/><polyline points="16 5 18 7 22 3"/></svg>`;
    },
    dragHandle(size = 16) {
      return `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="currentColor"><circle cx="9" cy="5" r="1.6"/><circle cx="15" cy="5" r="1.6"/><circle cx="9" cy="12" r="1.6"/><circle cx="15" cy="12" r="1.6"/><circle cx="9" cy="19" r="1.6"/><circle cx="15" cy="19" r="1.6"/></svg>`;
    },
    link(size = 16) {
      return `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>`;
    },
  };
}
...
class Router {
    ...
    const runNav = async () => {
      ...
      const urlMap = {
        ...
        playlists: this.state.selectedPlaylistId
          ...
          : '/playlists',
        // Cleaned up section using standard query parameters:
        artist: artistId
          ? albumId
  ...
  syncWithURL() {
    ...
    const deepLinkSong = new URLSearchParams(window.location.search).get('song');
  ...
  showArtistPopover(artistId, event) {
    ...
    popover.addEventListener('click', (e) => {
      ...
      if (action === 'go-artist') {
        ...
        if (a?.albums?.length) {
          btn.classList.add('popover-btn-pressed');
          const queue = Utils.buildAlbumQueue(state, a.id, a.albums[0].id);
    ...
    document.querySelectorAll('[data-song-id]').forEach(el => {
      el.addEventListener('dblclick', (e) => {
        ...
        if (el.dataset.context) {
          ...
          const queue = Utils.buildAlbumQueue(this.ui.state, ctx.artistId, ctx.albumId);
          if (queue.length) {
            this.ui.audioPlayer.playSong(queue.find(s => IdUtils.normalize(s.id) === IdUtils.normalize(songId)), queue, true, 'album');
            return;
          }
        }
        if (el.dataset.playlistId) {
          ...
          if (queue.length) {
            const startSong = queue.find(s => IdUtils.normalize(s.id) === IdUtils.normalize(songId)) || queue[0];
...
/* ============================================================================
   OfflineCacheManager — per-song offline caching over the service worker
   message API (CACHE_SONG / GET_CACHE_STATUS). Removal is cache-only:
   the SW API exposes no delete message, so the entry is dropped from the
   shared IndexedDB cache directly (best effort) and from local state.
   ============================================================================ */
...
class SearchManager {
  ...
  openSearch() {
    ...
    if (closeBtn) {
      const handler = () => this.closeSearch();
    ...
    document.querySelectorAll('[data-song-id]').forEach(el => {
      if (el.closest('.searchResultsContainer')) {
        el.addEventListener('click', (e) => {
          ...
          if (song) this.ui.audioPlayer.playSong(song, null, true, 'search');
          this.closeSearch();
        });
      }
    });
